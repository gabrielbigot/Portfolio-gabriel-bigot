...
export default function ImageModal({
  ...
  // Mode simple : juste l'image (pour les images de projets)
  const isSimpleMode = !description && !tags && !link
  ...
  return (
    ...
    >
      <div
        className={`relative w-full shadow-2xl animate-in zoom-in-95 duration-300 ${
          isSimpleMode
            ? "max-w-7xl bg-transparent"
            : "max-w-5xl bg-zinc-900 rounded-2xl overflow-hidden"
        }`}
      ...
      >
        ...
        {isSimpleMode ? (
          /* Mode simple - Image plein écran */
          <div className="space-y-4">
            <div className="relative w-full max-h-[85vh] aspect-video bg-black rounded-lg overflow-hidden">
              <Image
                src={imageSrc}
                alt={imageAlt}
                fill
          ...
          /* Mode complet - Image avec informations */

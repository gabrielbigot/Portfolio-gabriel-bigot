...
Mon objectif est d'intégrer SKEMA Business School avec une spécialisation en IA et transformation digitale, pour développer une expertise à l'intersection du business et de la technologie.`
  ...
  objectiveText: "Stage ADN POTENTIEL (jan–fév. 2026) suivi d'une mission freelance (avr–mai 2026) — Première rémunération pour des compétences en IA & développement full-stack.",
...
export const workExperience = [
  {
    position: "Développeur Freelance IA & Full-Stack",
    company: "ADN POTENTIEL",
    location: "Télétravail — Remote, France",
  ...
  technical: [
    {
      ...
      skills: [
        ...
        { name: "TypeScript", level: 72, description: "Typage strict, interfaces, types génériques" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Drizzle ORM", level: 68, description: "ORM typé, schéma Neon PostgreSQL, migrations SQL" },
...
└── scripts/                # utilitaires` },
  ...
  {
    id: "adn-dashboard",
    title: "ADN Dashboard — Application web IA sur-mesure",
    slug: "adn-dashboard",
    shortDescription: "Application web sur-mesure pour ADN POTENTIEL : veille d'actualités automatisée par IA, studio de création de posts avec aperçu LinkedIn et Instagram en temps réel, publication directe, et deux comptes utilisateurs séparés.",
    fullDescription: `Application web construite de zéro pour remplacer les outils n8n et Notion utilisés par ADN POTENTIEL. Six modules : Accueil, Veille, Studio, Calendrier, Coûts API et Paramètres. Gabriel et Loïc ont chacun leurs propres données sur le même dashboard. Déployée sur Vercel avec une base de données PostgreSQL.`,
    category: "Développement Web",
    tags: ["Next.js", "TypeScript", "Vercel", "Neon PostgreSQL", "OpenAI", "Instagram API", "LinkedIn API", "Apify"],
    date: "2026-05",
    company: "ADN POTENTIEL",
    featured: true,
    image: "/projects/adn-dashboard/accueil.png",
    problem: "L'outil d'automatisation utilisé pendant le stage atteignait sa limite mensuelle, bloquant la veille. Notion ne permettait pas de prévisualiser les publications ni de publier sur Instagram. L'ensemble était fragile.",
    solution: "Une application web sur-mesure déployée sur Vercel, remplaçant entièrement les anciens outils : sans limite d'exécutions, avec des aperçus réalistes des posts avant publication, et la possibilité de publier directement depuis l'interface.",
    impact: [
      "Plus aucune limite mensuelle — la veille tourne chaque jour sans interruption",
      "Aperçu LinkedIn et Instagram en temps réel dans le studio avant publication",
      "Publication directe sur LinkedIn et Instagram depuis l'application",
      "Deux comptes séparés : Gabriel et Loïc ont chacun leurs propres articles et posts",
      "Stats d'engagement LinkedIn (likes, commentaires) récupérées automatiquement",
      "Choix du modèle IA (OpenAI, Anthropic, Perplexity) modifiable sans toucher au code",
      "Templates de publication pour varier les formats (storytelling, liste, lead magnet…)"
    ],
    technologies: [
      { name: "Next.js 16", usage: "Framework web, tâches planifiées automatiques, API" },
      { name: "TypeScript", usage: "Typage strict sur l'ensemble du projet" },
      { name: "Neon PostgreSQL + Drizzle ORM", usage: "Base de données cloud" },
      { name: "JWT / bcryptjs", usage: "Authentification et sessions sécurisées" },
      { name: "LinkedIn API v2", usage: "Publication et suivi des posts" },
      { name: "Instagram Graph API", usage: "Publication de photos et visuels" },
      { name: "Apify", usage: "Récupération des statistiques d'engagement LinkedIn" },
      { name: "OpenAI / Anthropic / Perplexity", usage: "Analyse des articles, génération des posts" },
      { name: "DALL-E / Gemini", usage: "Génération d'images pour les publications" }
    ],
    challenges: [
      "Les statistiques LinkedIn (likes, commentaires) ne sont pas accessibles via l'API officielle sans validation de LinkedIn — résolu avec un outil tiers (Apify)",
      "La publication sur Instagram nécessite que l'image soit hébergée en ligne avant d'être envoyée — ajout d'une étape d'hébergement automatique",
      "Gérer l'expiration des connexions LinkedIn et identifier dynamiquement le compte auteur"
    ],
    learnings: [
      "Construire une application web complète (front, back, base de données) avec Next.js sur Vercel",
      "Mettre en place un système de connexion sécurisé fait maison, sans bibliothèque d'auth tierce",
      "Trouver des alternatives quand une API officielle est trop restrictive",
  ...
  {
    id: "mecenes-hdf-prospection-enrichissement",
    title: "Prospection & Enrichissement Mécènes — Hauts-de-France",
    slug: "mecenes-hdf-prospection-enrichissement",
    shortDescription: "Workflow automatisé pour identifier des entreprises mécènes potentielles en Hauts-de-France et récupérer leurs contacts clés (RSE, Communication, PDG) — 48 entreprises enrichies en quelques minutes.",
    fullDescription: "Automatisation n8n en deux modes : Enrichissement ajoute les contacts d'entreprises déjà listées, Prospection en identifie de nouvelles. L'IA (Gemini) recherche les noms, emails et téléphones des responsables. Résultats centralisés dans Google Sheets avec un score de sensibilité au mécénat.",
    category: "Automatisation",
    tags: ["n8n", "Gemini", "Pappers API", "Google Sheets", "Prospection", "IA"],
    date: "2026-04",
    company: "ADN POTENTIEL",
    featured: false,
    image: "/projects/mecenes-hdf-prospection-enrichissement/workflow.png",
    problem: "ADN POTENTIEL devait trouver des entreprises mécènes pour ses actions culturelles en Hauts-de-France. Rechercher manuellement les contacts de dizaines d'entreprises (RSE, Communication, PDG) prenait beaucoup de temps.",
    solution: "Un workflow déclenché par formulaire avec deux modes : Enrichissement pour des entreprises déjà connues, et Prospection pour en trouver de nouvelles. L'IA complète automatiquement les contacts et attribue un score de sensibilité au mécénat.",
    impact: [
      "48 entreprises enrichies avec les contacts RSE, Communication et PDG (nom, email, téléphone)",
      "Score de sensibilité de 1 à 5 étoiles pour prioriser les prises de contact",
      "~10 nouvelles entreprises identifiées par lancement (2-3 minutes d'exécution)",
      "Zéro recherche manuelle — tout est automatisé",
      "Tutoriel vidéo livré pour que l'équipe puisse l'utiliser en autonomie"
    ],
    technologies: [
      { name: "n8n", usage: "Orchestration du workflow, formulaire de déclenchement, logique conditionnelle" },
      { name: "Gemini API", usage: "Recherche des contacts décisionnaires, scoring mécénat" },
      { name: "Pappers API", usage: "Vérification et données légales des entreprises" },
      { name: "Google Sheets", usage: "Stockage et mise à jour des données" }
    ],
    challenges: [
      "Les contacts générés par l'IA (emails, téléphones) peuvent être approximatifs — nécessite une vérification avant envoi",
      "Éviter les doublons lors de plusieurs lancements successifs sur les mêmes entreprises",
      "Certains noms d'entreprise ne correspondent à aucune fiche légale — gestion des cas non trouvés"
    ],
    learnings: [
      "Construire un workflow conditionnel avec deux chemins d'exécution depuis un seul formulaire",
      "Combiner une base de données légale et l'IA pour des résultats plus fiables",
      "Un workflow sans tutoriel reste inutilisé — la documentation est aussi importante que le code"
    ],
    media: [
      { url: "/projects/mecenes-hdf-prospection-enrichissement/workflow.png", caption: "Workflow n8n — vue des deux modes (Prospection en haut, Enrichissement en bas)" }
    ],
    content: [
      { type: 'heading', text: `Deux modes, un seul formulaire` },
      { type: 'paragraph', text: `Le workflow se lance depuis un formulaire avec un champ "Mode". Selon le choix, il prend deux chemins différents.` },
      { type: 'heading', text: `Mode Enrichissement` },
      { type: 'paragraph', text: `Pour des entreprises déjà connues : une API légale (Pappers) retrouve les informations officielles de l'entreprise, puis Gemini recherche les contacts RSE, Communication et PDG avec leurs emails et téléphones. Un second appel IA attribue un score de sensibilité au mécénat.` },
...
export const companies = [
  {
    id: "adn-potentiel-freelance-2026",
